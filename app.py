...
# None值过滤
application.add_middleware(Middleware.ExcludeNoneMiddleware)
...
if __name__ == "__main__":
    #uvicorn.run("app:app", workers=multiprocessing.cpu_count()*2+1, host="0.0.0.0", port=8000, reload=True)
